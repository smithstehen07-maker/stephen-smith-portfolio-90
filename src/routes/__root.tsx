...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio of Stephen Smith — Senior Full-Stack Software Engineer specializing in AI/LLM evaluation, scalable web apps, and high-quality code." },
      { name: "author", content: "Stephen Smith" },
      { property: "og:title", content: "Stephen Smith — Senior Full-Stack Engineer" },
      { property: "og:description", content: "Building scalable applications, evaluating LLMs, crafting high-quality code." },
